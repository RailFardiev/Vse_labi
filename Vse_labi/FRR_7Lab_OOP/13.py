...
student1 = Student("Vasya", "Hromov", 20, {"Кол-во пятёрок": 5, "Кол-во четвёрок": 3, "Кол-во троек": 1})
student2 = Student("Kostya", "Fremov", 22, {"Кол-во пятёрок": 4, "Кол-во четвёрок": 4, "Кол-во троек": 2})
student3 = Student("Rail", "Fardiev", 20, {"Кол-во пятёрок": 3, "Кол-во четвёрок": 5, "Кол-во троек": 1})
